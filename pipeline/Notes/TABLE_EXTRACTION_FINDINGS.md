...
"provenance": [
  {
    "docling_ref": "#/texts/1",   // ← References text, not tables
    "label": "text",
    "pages": [...]
  }
]
...
"provenance": [
  {
    "docling_ref": "#/tables/0",  // ← This doesn't exist in chunks
    "label": "table",
    "pages": [...]
  }
]
...
1. ✅ **Schema**: `table_id` field exists in Dgraph
2. ✅ **API**: `/api/relations/by-table` endpoint works
3. ✅ **Data Loader**: Checks for `docling_ref: "#/tables/X"` and extracts `table_id`
4. ✅ **Documentation**: Complete with examples

**Missing piece:** The chunking step that converts Docling JSON → text chunks **skips tables entirely**.
...
for table_element in docling_json['tables']:
    create_chunk(table_element)  # ← ADD THIS
```
