...
| `MEASUREMENT` | Numeric measurements | "100 ppm", "25Â°C"       |
...
- "RÂ² = 0.87" (quantitative correlation)
...
- Typical volume: 10-50 relations (2-5 figures Ã— 5-10 relations each)
- Deduplication: ~5% duplicates

**Table Triples**:

- Load time: 3-10 seconds per paper
- Typical volume: 20-100 relations (2-5 tables Ã— 10-20 relations each)
