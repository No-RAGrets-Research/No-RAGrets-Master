...
- **Processing Time**: 2025-10-12T14:47:02.918228
...
- **Markdown No BBox Length**: 0 characters
- **Status**: Failed

### Chunks Extracted
- **Total Chunks**: 0
- **Markdown BBox Chunks**: 0
- **Markdown No BBox Chunks**: 0
- **Detection Only Chunks**: 0
- **Pages Processed**: 13
...
| Markdown Output (Clean) | 0 chars | Compare | Compare | Compare |
| Total Chunks | 0 | Compare | Compare | Compare |
...
### Processing Pipeline:
1. PDF → High-resolution images (300 DPI)
2. Images → NVIDIA NeMo API (3 modes)
3. API responses → Aggregated analysis
...
*Processing completed: 2025-10-12T14:47:02.918228*
