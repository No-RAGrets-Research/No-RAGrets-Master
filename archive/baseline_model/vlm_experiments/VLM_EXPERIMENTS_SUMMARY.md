...
- **PyMuPDF**: ❌ No table detection (sees as plain text)
- **Docling**: ✅ **2 tables extracted** with proper structure
- **Landing AI**: ✅ Advanced table understanding and content analysis
- **NVIDIA NeMo**: ✅ Basic table detection capabilities

### Image/Figure Analysis

- **PyMuPDF**: ❌ No image processing (0 image chunks)
- **Docling**: ⚠️ Basic image detection (9 image placeholders)
- **Landing AI**: ✅ **Detailed figure descriptions** and visual understanding
- **NVIDIA NeMo**: ✅ Image-based analysis with OCR capabilities
...
| Landing AI  | 81,685     | 208    | ✓      | ✓      | API/Slow     | $0.10/page\*  |
| NVIDIA NeMo | 60,320     | 26     | ✓      | ✓      | API/Medium   | $0.002/page\* |
