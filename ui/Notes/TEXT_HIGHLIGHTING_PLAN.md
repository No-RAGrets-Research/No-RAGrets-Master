...
1. **Text-based highlighting** ✅ - The library's core strength, searches for text in PDF
2. **Area/Image highlighting** ✅ - **CONFIRMED!** Supports rectangular area selection for figures/images
...
3. **Multi-highlight support** ✅ - Can show many highlights simultaneously
4. **Scroll to highlight** ✅ - Built-in navigation
5. **Custom styling** ✅ - Configurable highlight colors and styles
...
3. **Hover preview**
   ...
   - Tooltip showing subject → predicate → object
...
1. ✅ **Accurate** - Finds exact text, not approximate coordinates
2. ✅ **Scalable** - Works at any zoom level
3. ✅ **Robust** - Library handles PDF quirks
4. ✅ **Better UX** - Can highlight actual words, not just boxes
5. ✅ **Multi-page** - Can highlight same entity across pages
6. ✅ **Persistent** - Can save highlight positions
...
src/components/pdf-viewer/
  ├── PDFViewer.tsx (keep for fallback)
  ├── PdfHighlighterView.tsx (NEW - main component)
  ├── HighlightPopup.tsx (NEW - shows relation on hover)
  └── useTextHighlighting.ts (NEW - search logic)
```
