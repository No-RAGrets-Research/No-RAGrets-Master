...
no-ragrets-ui/
├── public/
│   └── papers/                 # Static PDF files (symlinked or copied)
├── src/
│   ├── components/
│   │   ├── pdf-viewer/
│   │   │   ├── PDFViewer.tsx          # Main PDF viewer component
│   │   │   ├── PDFHighlighter.tsx     # Overlay for highlighting relations
│   │   │   ├── TextSelector.tsx       # Handle text selection
│   │   │   └── FigureMarker.tsx       # Mark and click figures
│   │   ├── graph/
│   │   │   ├── KnowledgeGraph.tsx     # Main graph visualization
...
│   │   │   ├── RelationPanel.tsx      # Relation details sidebar
│   │   │   ├── CrossPaperView.tsx     # Cross-paper comparison
│   │   │   └── ProvenancePanel.tsx    # Source provenance details
│   │   ├── llm/
│   │   │   ├── LLMAnalyzer.tsx        # LLM analysis interface
│   │   │   ├── PromptEditor.tsx       # Custom prompt input
│   │   │   ├── RubricConfig.tsx       # Rubric configuration
│   │   │   └── AnalysisResults.tsx    # Display analysis results
│   │   ├── layout/
│   │   │   ├── MainLayout.tsx         # App shell
│   │   │   ├── Sidebar.tsx            # Navigation sidebar
│   │   │   └── ResizablePanels.tsx    # Split view layout
│   │   └── common/
│   │       ├── SearchBar.tsx          # Entity/relation search
│   │       ├── PaperList.tsx          # Paper selection
│   │       └── FilterPanel.tsx        # Filtering controls
│   ├── services/
│   │   ├── api/
│   │   │   ├── client.ts              # Axios instance configuration
│   │   │   ├── entities.ts            # Entity API calls
│   │   │   ├── relations.ts           # Relation API calls
│   │   │   ├── papers.ts              # Paper API calls
│   │   │   ├── provenance.ts          # Provenance API calls
│   │   │   └── analytics.ts           # Analytics API calls
│   │   ├── llm/
│   │   │   └── analyzer.ts            # LLM integration service
│   │   └── pdf/
│   │       └── coordinator.ts         # PDF coordinate mapping
│   ├── types/
│   │   ├── entities.ts                # Entity type definitions
│   │   ├── relations.ts               # Relation type definitions
│   │   ├── papers.ts                  # Paper type definitions
│   │   └── api.ts                     # API response types
│   ├── hooks/
│   │   ├── useEntitySearch.ts         # Entity search hook
│   │   ├── useRelationSearch.ts       # Relation search hook
│   │   ├── useEntityConnections.ts    # Entity connections hook
│   │   ├── usePaperData.ts            # Paper data hook
│   │   └── useLLMAnalysis.ts          # LLM analysis hook
│   ├── store/
│   │   ├── index.ts                   # Store configuration
│   │   ├── paperStore.ts              # Selected paper state
│   │   ├── graphStore.ts              # Graph state
│   │   └── selectionStore.ts          # User selection state
│   ├── utils/
│   │   ├── coordinates.ts             # PDF coordinate transformations
...
- [ ] Click sentence in PDF → highlight entities → show in graph
- [ ] Click node in graph → show in all PDFs where it appears
- [ ] Click relation → jump to source PDF with highlight
...
3. User clicks "methane → methanol" relation
...
Let's build an amazing research exploration tool! 🚀
